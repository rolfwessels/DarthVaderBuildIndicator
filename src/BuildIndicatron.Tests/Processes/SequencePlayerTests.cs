...
namespace BuildIndicatron.Tests.Processes
{
    ...
    public class SequencePlayerTestsTests
    {
        ...
        public void Setup()
        {
            ...
            _sequencePlayerTests = new SequencePlayer(_mockITextToSpeech.Object, _mockIMp3Player.Object,
                _mockIVoiceEnhancer.Object, _mockISoundFilePicker.Object, _mockIPinManager.Object);
        }
