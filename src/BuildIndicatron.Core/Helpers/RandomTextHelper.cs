namespace BuildIndicatron.Core.Helpers
{
    public class RandomTextHelper
    {
        ...
        private static string[] _insult = new[]
        {
        ...
        {
            "SendQuotesI find your lack of faith disturbing.", "You don't know the power of the dark side!",
        ...
        private static string[] _greetings = new[]
        {
            "Hi",
            "Good morning",
            "Morning!",
        ...
        private static string[] _dontUnderStand = new[]
        {
            "I beg your pardon?",
        ...
        {
            get { return (_quotes).Random(); }
        }

        public static string Insult
        {
            get { return (_insult).Random(); }
        }

        public static string OneLiner
        {
            get { return (_oneLiners).Random(); }
        }

        public static string Greetings
        {
            get { return (_greetings).Random(); }
        }

        public static string DontUnderstand
        {
            get { return (_dontUnderStand).Random(); }
        }
    }
}