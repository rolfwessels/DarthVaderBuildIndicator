...
namespace BuildIndicatron.Core.Processes
{
    public class SequencePlayer : ISequencePlayer
    {
        ...
        public SequencePlayer(ITextToSpeech textToSpeech, IMp3Player mp3Player, IVoiceEnhancer voiceEnhancer,
            ISoundFilePicker soundFilePicker, IPinManager pinManager)
        {
